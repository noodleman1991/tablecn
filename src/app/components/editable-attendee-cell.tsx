...
import { updateAttendeeDetails } from "@/app/actions";

interface EditableAttendeeCellProps {
  value: string | null;
  attendeeId: string;
...
export function EditableAttendeeCell({
  value,
  attendeeId,
  field,
  placeholder = "",
}: EditableAttendeeCellProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      await updateAttendeeDetails(attendeeId, field, trimmedValue);
